...
Public Class recep
    ...
    Private Sub recep_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Start()
        Label32.Text = 20
        ...
        picpic.Image = Drawing.Image.FromStream(mems)
        Label32.Text = 20
        messagemosiya()
        readfriends()
        grids()
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles pic.Click
        image_dp.Show()
    End Sub
