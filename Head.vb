...
Public Class Head
    ...
    Private Sub BunifuFlatButton1_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton1.Click
        ...
        If BunifuFlatButton1.Activecolor = Color.FromArgb(213, 219, 219) Then
            BunifuFlatButton1.Textcolor = Color.FromArgb(167, 58, 53)
    ...
    Private Sub BunifuFlatButton3_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton3.Click
        ...
        If BunifuFlatButton3.Activecolor = Color.FromArgb(213, 219, 219) Then
            BunifuFlatButton3.Textcolor = Color.FromArgb(167, 58, 53)
            BunifuFlatButton2.Textcolor = Color.White
    ...
    Private Sub BunifuFlatButton6_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton6.Click
        ...
        If BunifuFlatButton6.Activecolor = Color.FromArgb(213, 219, 219) Then
            BunifuFlatButton6.Textcolor = Color.FromArgb(167, 58, 53)
            BunifuFlatButton2.Textcolor = Color.White
            BunifuFlatButton3.Textcolor = Color.White
            BunifuFlatButton4.Textcolor = Color.White
            BunifuFlatButton1.Textcolor = Color.White
    ...
    Private Sub BunifuFlatButton2_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton2.Click
        ...
        If BunifuFlatButton2.Activecolor = Color.FromArgb(213, 219, 219) Then
            BunifuFlatButton2.Textcolor = Color.FromArgb(167, 58, 53)
            BunifuFlatButton6.Textcolor = Color.White
            BunifuFlatButton3.Textcolor = Color.White
            BunifuFlatButton1.Textcolor = Color.White
            BunifuFlatButton4.Textcolor = Color.White
    ...
    Private Sub BunifuFlatButton4_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton4.Click
        ...
        If BunifuFlatButton4.Activecolor = Color.FromArgb(213, 219, 219) Then
            BunifuFlatButton4.Textcolor = Color.FromArgb(167, 58, 53)
            BunifuFlatButton6.Textcolor = Color.White
            BunifuFlatButton3.Textcolor = Color.White
            BunifuFlatButton1.Textcolor = Color.White
            BunifuFlatButton2.Textcolor = Color.White
    ...
    Private Sub BunifuFlatButton5_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton5.Click
        ...
        If BunifuFlatButton5.Activecolor = Color.FromArgb(213, 219, 219) Then
            BunifuFlatButton5.Textcolor = Color.FromArgb(167, 58, 53)
            BunifuFlatButton6.Textcolor = Color.White
            BunifuFlatButton3.Textcolor = Color.White
            BunifuFlatButton1.Textcolor = Color.White
            BunifuFlatButton2.Textcolor = Color.White
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        Label33.Text = DateAndTime.TimeOfDay
    ...
    Private Sub Head_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Timer1.Start()
        Dim mems As System.IO.MemoryStream = New System.IO.MemoryStream(Convert.FromBase64String(My.Settings.displaypic))
        pic.Image = Drawing.Image.FromStream(mems)
    ...
    Public Sub sendmessage()
        Try
            con = New MySqlConnection(conn)
            Dim insert As String = "INSERT INTO tbl_pm (username,fromuser,Message,isread) VALUES('" & frdusrname & "', '" & My.Settings.Username & "','" & DateTimePicker1.Value.ToString("D") + "/" & Label33.Text & ": " + RichTextBox1.Text & "','" & "Unread" & "')"
            executequery(insert)
    ...
    Private Sub TextBox10_TextChanged(sender As Object, e As EventArgs) Handles TextBox10.TextChanged
        Try
            ...
            dv.RowFilter = String.Format("Lastname like '%{0}%'", TextBox10.Text)
